...
const consumptionController= require('./../controllers/consumptionController.js')
...
//get 5 most popular kitchen items consumed with the quantity
router.get('/consumptions/top-consumed-items', listAllConsumedItems);
